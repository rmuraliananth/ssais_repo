								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control datepicker" name="openDate" ng-model="customer.account.openDate" placeholder="Open Date" ng-required="true">
											</div>
										</div>	
										<p></p>
										<div class="row">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control datepicker" name="maturityDate" ng-model="customer.account.maturityDate"  placeholder="Maturity Date" ng-required="true">
											</div>
										</div>	
								 	</div>
								 </div>
