package com.po.ssais.security.filter;
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			if (request instanceof SecurityContextHolderAwareRequestWrapper) {
				SecurityContextHolderAwareRequestWrapper o = (SecurityContextHolderAwareRequestWrapper) request;
				if (!o.isRequestedSessionIdValid()) {
					logger.debug("Session has been expired");
